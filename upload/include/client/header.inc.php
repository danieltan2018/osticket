...
<head>
	...
	<link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?f4a172f" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?f4a172f" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?f4a172f" media="print"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/typeahead.css?f4a172f"
         media="screen" />
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css?f4a172f"
        rel="stylesheet" media="screen" />
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?f4a172f" media="screen"/>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/flags.css?f4a172f"/>
    ...
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?f4a172f"></script>
    ...
    <script src="<?php echo ROOT_PATH; ?>scp/js/bootstrap-typeahead.js?f4a172f"></script>
